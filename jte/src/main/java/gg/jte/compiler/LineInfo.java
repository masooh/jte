...
final class LineInfo {
    ...
    private static final List<TemplateParser.Mode> ForLoopEndModes = Arrays.asList(TemplateParser.Mode.ForLoop, TemplateParser.Mode.ForIndexLoop, TemplateParser.Mode.Text);
